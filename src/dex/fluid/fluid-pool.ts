...
import { FluidData, PoolState } from './types';
import { FluidConfig } from './config';

export class FluidEventPool extends StatefulEventSubscriber<PoolState> {
  handlers: {
  ...
  constructor(
    ...
    logger: Logger,
    protected fluidIface = new Interface(
      '' /* TODO: Import and put here Fluid ABI */,
    ), // TODO: add any additional params required for event subscriber
  ) {
    super(parentName, logger);

    // TODO: make logDecoder decode logs that
    this.logDecoder = (log: Log) => this.fluidIface.parseLog(log);
