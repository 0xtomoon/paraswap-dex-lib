...
/*
  ...
  This test script should add e2e tests for Fluid. The tests
  ...
  tokenB with any two highly liquid tokens on Fluid for the tests
  to work. If the tokens that you would like to use are not defined in
  Tokens or Holders map, you can update the './tests/constants-e2e'

  Other than the standard cases that are already added by the template
  it is highly recommended to add test cases which could be specific
  to testing Fluid (Eg. Tests based on poolType, special tokens,
  etc).
...
describe('Fluid E2E', () => {
  ...
  describe('Fluid MAINNET', () => {
    ...
    // TODO: Add any additional test cases required to test Fluid
  });
});
